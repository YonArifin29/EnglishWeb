<?php
    ...
    $active1 = "active";
    $judul = "INTRODUCTION";
    $judul2 = "<div class='ml-5'>(Pendahuluan)</div>";
    $hal = 1;
    $tombol = "
        <div class='btn btn-primary btn-sm mb-2'>
        <a class='text-reset'href='?page=babKedua/pengertian'>Selanjutnya</a>
        </div>
    ";
    $konten = "
            <div class='row'>
                <div class='ml-5 container'>
                    ...
                    <p class='paragraf'>
                        Didalam Tata Bahasa Inggris (English Grammar) dikenal ada 8 (delapan) jenis kata sebagai unsur pembentuk kalimat, yaitu :
                    </p>
                    <div class='ml-5'>
